  ...
  getScenarios() {
    return [
      ...
      [
        ...
        {
          type: 'ai',
          text: '보통 18-24개월이면 투자금 회수가 가능합니다. 상세 ROI 분석은 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '대부분의 기존 CCTV와 통합 가능합니다. 현장 조사를 통해 정확한 방안을 제시해드립니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '문제가 해결되어 다행입니다. 조명 일정 및 센서 설정은 모바일 앱에서 조정 가능합니다. 추가 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '센서 방식으로 사람 수만 카운팅하여 개인정보 이슈가 없습니다. 상세 상담은 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '모든 환경 데이터가 클라우드에 자동 저장되어 언제든 조회 및 리포트 출력이 가능합니다. 상세 상담은 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '문제가 해결되어 다행입니다. 센서는 6개월마다 자동 캘리브레이션됩니다. 추가 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '대부분의 기존 차단기와 통합 가능합니다. 현장 조사 후 상세 제안서를 드립니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: 'POS 시스템과 연동하여 판매 패턴을 분석하고 최적의 발주 타이밍을 제안합니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '대부분의 호텔 PMS와 API 연동 가능합니다. 체크인/아웃 자동화도 지원합니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '기준치 이탈 시 즉시 모바일 알림을 보내며, 긴급 상황 시 자동 대응합니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '구역별 온습도 기록이 자동 저장되어 제품 보관 이력 관리와 품질 보증에 활용 가능합니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '배터리 수명은 약 6개월입니다. 다음 교체 시기 2주 전에 미리 알림을 보내드립니다. 추가 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '사용 횟수나 악취 수준 기준 초과 시 청소 직원 앱으로 알림을 보냅니다. 청소 이력 관리도 자동화됩니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
      ...
      [
        ...
        {
          type: 'ai',
          text: '라인별, 설비별 가동률, 비가동 사유, OEE 지표를 실시간 대시보드로 제공합니다. 홈페이지 하단 연락처의 영업문의 이메일로 문의 주세요.',
          delay: 800,
          typingDelay: 1200
        }
      ],
