...
class ChatbotUI {
  ...
  getDefaultResponses() {
    return {
      // 제품 및 솔루션 문의
      '무인매장,무인,매장': '무인 매장 IoT 솔루션에 관심 가져주셔서 감사합니다. 출입 관리, 결제 시스템, 재고 관리 등 통합 솔루션을 제공하고 있습니다. 견적 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
      '상업시설,상업,시설,빌딩': '상업 시설 IoT 솔루션 문의 감사합니다. 에너지 관리, 보안 시스템, 환경 제어 등 맞춤형 솔루션을 제공합니다. 자세한 상담은 070-7780-5577로 연락 주세요.',
      'iot센서,센서,온도센서,습도센서': 'IoT 센서 솔루션에 관심 가져주셔서 감사합니다. 온도, 습도, 조도, 동작 감지 등 다양한 센서를 제공하며, 실시간 모니터링이 가능합니다. 상세 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
      '스마트조명,조명,조명제어': '스마트 조명 제어 시스템 문의 감사합니다. 자동 일정 제어, 밝기 조절, 에너지 절감 기능을 제공합니다. 데모 요청은 070-7780-5577로 연락 주세요.',
      '에너지,전력,절감': '에너지 관리 시스템(EMS) 문의 감사합니다. 실시간 전력 모니터링, 소비 분석, 자동 제어로 최대 30% 에너지 절감이 가능합니다. 자세한 상담은 홈페이지 하단 연락처의 기술문의 이메일로 연락 주세요.',
      'cctv,보안,감시,카메라': 'IoT 기반 CCTV 보안 시스템 문의 감사합니다. AI 영상 분석, 실시간 알림, 원격 모니터링 기능을 제공합니다. 견적 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
      '재고,재고관리,창고': '스마트 재고 관리 시스템 문의 감사합니다. RFID/바코드 기반 실시간 재고 추적, 자동 발주 알림 기능을 제공합니다. 데모 요청은 070-7780-5577로 연락 주세요.',
      '결제,페이,결제시스템': '무인 결제 시스템 문의 감사합니다. QR코드, NFC, 카드 결제를 지원하며, PG사 연동도 가능합니다. 상세 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',

      // 기술 및 지원 문의
      '기술지원,지원,문제,오류': '기술 지원이 필요하신가요? 홈페이지 하단 연락처의 기술문의 이메일로 문의 주시거나 070-7780-5577로 연락 주세요. 신속하게 지원해드리겠습니다.',
      '원격,원격모니터링,모니터링': '원격 모니터링 시스템 문의 감사합니다. 실시간 데이터 조회, 알림 설정, 웹/모바일 대시보드를 제공합니다. 데모는 070-7780-5577로 문의 주세요.',
      'api,연동,integration': 'API 연동 문의 감사합니다. REST API를 통해 외부 시스템과 연동 가능하며, 기술 문서를 제공합니다. 개발자 문의는 홈페이지 하단 연락처의 기술문의 이메일로 연락 주세요.',
      '설치,시공,공사': '설치 및 시공 문의 감사합니다. 전문 엔지니어가 현장 방문하여 설치를 진행하며, 사후 지원도 제공합니다. 일정 문의는 070-7780-5577로 연락 주세요.',
      '유지보수,as,보수': '유지보수 서비스 문의 감사합니다. 정기 점검, 장애 대응, 소프트웨어 업데이트를 포함한 유지보수 계약을 제공합니다. 상세 문의는 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
      '긴급,urgent,emergency': '긴급 지원이 필요하신가요? 070-7780-5577로 즉시 연락 주시면 신속하게 대응하겠습니다. 24시간 긴급 지원 서비스를 운영하고 있습니다.',

      // 영업 및 상담 문의
      '견적,가격,비용': '견적 문의 감사합니다. 프로젝트 규모와 요구사항에 따라 맞춤 견적을 제공해드립니다. 홈페이지 하단 연락처의 영업문의 이메일로 상세 내용을 보내주시면 검토 후 회신 드리겠습니다.',
      '데모,시연,테스트': '제품 데모 요청 감사합니다. 실제 작동하는 시스템을 직접 보실 수 있도록 현장 방문 데모를 제공합니다. 일정 조율은 070-7780-5577로 연락 주세요.',
      '상담,컨설팅,미팅': '상담 요청 감사합니다. IoT 전문가가 귀사의 요구사항을 분석하여 최적의 솔루션을 제안해드립니다. 상담 예약은 홈페이지 하단 연락처의 영업문의 이메일로 연락 주세요.',
      '포트폴리오,실적,사례': '포트폴리오 문의 감사합니다. 무인 매장, 오피스 빌딩, 상업 시설 등 다양한 구축 사례가 있습니다. 상세 자료는 홈페이지 하단 연락처의 영업문의 이메일로 요청해주세요.',
      '제안서,proposal': '제안서 요청 감사합니다. 프로젝트 개요를 홈페이지 하단 연락처의 영업문의 이메일로 보내주시면 맞춤형 제안서를 작성하여 보내드리겠습니다.',
